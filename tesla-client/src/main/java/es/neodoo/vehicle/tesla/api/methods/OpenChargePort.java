...
public class OpenChargePort {
	...
	private final static Logger log = Logger
			.getLogger(OpenChargePort.class.getName());
	...
	public OpenChargePortResponse execute(int vehicleId)
		...
		try {
			...
			WebResource webResource = client.resource(
					teslaInvoker.getUri() + "/" + TeslaInvoker.URL_PATH_VEHICLES
							+ "/" + vehicleId + URL_OPEN_CHARGE_PORT);
			...
			throw new TeslaInvokerException(
					"Error invoking open charge port service: "
							+ e.getMessage());
		}
