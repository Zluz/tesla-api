...
public class SetChargeLimitToMaxRange {
	...
	private final static Logger log = Logger
			.getLogger(SetChargeLimitToMaxRange.class.getName());
	...
	public SetChargeLimitToMaxRangeResponse execute(int vehicleId)
		...
		try {
			...
			WebResource webResource = client.resource(teslaInvoker.getUri()
					...
					+ URL_SET_CHARGE_LIMIT_TO_MAX_RANGE);
			...
			throw new TeslaInvokerException(
					"Error invoking set charge to max range service: "
							+ e.getMessage());
		}
