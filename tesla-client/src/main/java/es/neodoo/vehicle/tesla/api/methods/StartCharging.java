...
public class StartCharging {
	...
	private final static Logger log = Logger
			.getLogger(StartCharging.class.getName());
	...
	public StartChargingResponse execute(int vehicleId)
		...
		try {
			...
			throw new TeslaInvokerException(
					"Error invoking start charging service: " + e.getMessage());
		}
