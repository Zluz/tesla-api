...
public class StopHvacSystem {
	...
	private final static Logger log = Logger
			.getLogger(StopHvacSystem.class.getName());
	...
	public StopHvacSystemResponse execute(int vehicleId)
		...
		try {
			...
			WebResource webResource = client.resource(
					teslaInvoker.getUri() + "/" + TeslaInvoker.URL_PATH_VEHICLES
							+ "/" + vehicleId + URL_STOP_HVAC_SYSTEM);
			...
			throw new TeslaInvokerException(
					"Error invoking stop HVAC system service: "
							+ e.getMessage());
		}
